  ...
  const draw = useCallback(
    (now) => {
      ...
      const theme = {
        default: {
          bg: "#0b0f19",
          lineActive: { r: 99, g: 102, b: 241, a: 0.9 }, // Indigo accent matching AegisPath theme
  ...
  return (
    <div
      className={cn(
        ...
        globalColor === "monochrome" ? "bg-[#000000]" : "bg-[#0b0f19]",
        className
      )}
    >
      <canvas
